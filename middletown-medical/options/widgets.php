...
* Text Widget
*/
class MMTextWidget extends Carbon_Widget {
	/*
	...
	*/
	...
	function MMTextWidget() {
		$this->setup('Rich Text Widget', 'Displays a block with title/text', array(
			Carbon_Field::factory('text', 'title', 'Title'),
			Carbon_Field::factory('rich_text', 'text', 'Content')
		));
	}
