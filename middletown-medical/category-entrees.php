<?php get_header();
  ...
  <div class="main-category-entree" id="recipecard-header">
    <ul>
      <li class="main-category-title-entree">Entr&eacute;es</li>
    </ul>
  </div>
  <!--end recipecard-header-->
  
  <div id="categorycard-content">
    <ul class="entree-list"><?php if (have_posts()) : ?>
...
<?php endif; ?></ul>
  ...
  <div id="recipecard-nav">
    <ul>
      <li>&laquo; <a href="/recipes/desserts/">DESSERTS</a></li>
      <li class="recipe-right"><a href="/recipes/appetizers/">APPETIZERS</a> &raquo;</li>
    </ul>
  </div>
  <!--end recipecard-nav-->
