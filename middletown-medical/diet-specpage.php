<?php 
/*
	Template Name: Diet Service Page
*/
get_header(); ?>
...
//echo ($shortSpec);
$params = array (
						'where' => "( field_of_practice.meta_value = 'Diabetes' OR field_of_practice.meta_value = 'Dieticians' OR field_of_practice.meta_value = 'Dietician and Diabetes Educator')"
    );
