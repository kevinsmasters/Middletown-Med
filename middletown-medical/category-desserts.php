<?php get_header();
  ...
  <div class="main-category-dessert" id="recipecard-header">
    <ul>
      <li class="main-category-title-dessert">Desserts</li>
    </ul>
  </div>
  <!--end recipecard-header-->
  
  <div id="categorycard-content">
    <ul class="dessert-list"><?php if (have_posts()) : ?>
...
<?php endif; ?></ul>
  ...
  <div id="recipecard-nav">
    <ul>
      <li>&laquo; <a href="/recipes/appetizers/">APPETIZERS</a></li>
      <li class="recipe-right"><a href="/recipes/appetizers/">ENTR&Eacute;ES</a> &raquo;</li>
    </ul>
  </div>
  <!--end recipecard-nav-->
