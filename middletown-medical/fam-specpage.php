<?php 
/*
	Template Name: Family Service Page
*/
get_header(); ?>
...
//echo ($shortSpec);
$params = array (
						'where' => "( field_of_practice.meta_value = 'Family Medicine' OR field_of_practice.meta_value = 'Internal Medicine' OR field_of_practice.meta_value = 'Primary Care' OR field_of_practice.meta_value LIKE '%\"Internal Medicine\"%')"
    );
